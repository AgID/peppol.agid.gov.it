...
I Service Provider che già dispongono di una certificazione ISO/IEC 27001 devono verificare che lo **Statement of Applicability** (SOA) copra esplicitamente l'ambito delle operazioni Peppol (Access Point, Service Metadata Publisher, End User Identification, gestione documenti, controlli di integrità, logging e audit trail, backup e continuità operativa).
I Service Provider che non dispongono ancora della certificazione devono avviare tempestivamente il progetto di implementazione, coinvolgendo un organismo di certificazione accreditato specializzato in ISO/IEC 27001.
...
Per ulteriori informazioni si rimanda alla pagina dedicata [ISO/IEC 27001](https://openpeppol.atlassian.net/wiki/spaces/Security/pages/5232230408/ISO+IEC+27001) di OpenPeppol e al piano di implementazione [allegato](/attachments/Implementation%20plan%20ISO-27001%20v1.0rc.docx).
